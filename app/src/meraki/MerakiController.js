...
(function(){
    ...
    angular
        .module('meraki')
        .controller('MerakiController', ['$mdSidenav','User','Organization','MSP','Cachebox','OAuth', MerakiController]);
     ...
     * @constructor
     */
    function MerakiController( $mdSidenav, User, Organization, MSP, Cachebox, OAuth ) {
        var self = this;
