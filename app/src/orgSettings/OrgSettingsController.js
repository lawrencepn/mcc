...
(function(){
    ...
    angular
        .module('orgsettings')
        .controller('OrgSettingsController', ['$mdSidenav','User','Organization','MSP','Cachebox','OAuth', OrgSettingsController]);
     ...
     * @constructor
     */
    function OrgSettingsController( $mdSidenav, User, Organization, MSP, Cachebox, OAuth ) {
        var self = this;
