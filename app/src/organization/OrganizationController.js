...
(function(){
    ...
    angular
        .module('org')
        .controller('OrgController', ['$mdSidenav','User','Organization','MSP','Cachebox','OAuth','$stateParams','$scope', OrganizationController]);
     ...
     * @constructor
     */
    function OrganizationController( $mdSidenav, User, Organization, MSP, Cachebox, OAuth, $stateParams, $scope) {
        var self = this;
